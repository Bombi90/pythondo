...
def display_board(board, message):
    return f"""
            ...
            <div id="tictactoe" class="container">
                ...
                <h3>{message}</h3>
                <div>
                    <p>Player 1 is <strong>X</strong> <input id="player-one-input" /> <button id="player-one-button">Submit</button></p>
                    <p>Player 2 is <strong>O</strong> <input id="player-two-input" /> <button id="player-two-button">Submit</button></p>
...
def tictactoe():
    ...
    board = display_board(the_board, who_won)
    return {
            "html": board
    }